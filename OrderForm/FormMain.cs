...
namespace OrderForm {
  public partial class FormMain : Form {
    ...
    public FormMain() {
      ...
      Order order = new Order(1, new Customer("1", "ZhangSan"), new List<OrderItem>());
      order.AddItem(new OrderItem(1, new Goods("1", "Noodles", 100.0), 10));
      orderService.AddOrder(order);
      Order order2 = new Order(2, new Customer("2", "WangWu"), new List<OrderItem>());
      order2.AddItem(new OrderItem(1, new Goods("2", "Rices", 200.0), 10));
